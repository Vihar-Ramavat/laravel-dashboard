        ...
        <div class="w-full max-w-md bg-white shadow-md rounded-lg px-8 py-10">
            ...
            <form id="loginForm" class="mb-4" method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4 relative">
                    ...
                    <svg id="showPassword" class="absolute right-3 top-3 h-6 w-6 cursor-pointer text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <svg id="hidePassword" class="absolute right-3 top-3 h-6 w-6 cursor-pointer text-gray-500 hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
