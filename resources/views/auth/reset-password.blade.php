...
@section('content')
    <div class="flex justify-center items-center h-screen bg-gradient-to-r from-purple-800 to-indigo-900">
        <div class="w-full max-w-md bg-white shadow-md rounded-lg px-8 py-10">
            <h2 class="text-3xl text-center font-bold mb-6 text-indigo-500">Reset Your Password</h2>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="mb-4">
                ...
                <div class="mb-4">
                    <input class="border-b border-indigo-300 w-full py-2 px-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:border-indigo-500" id="password" type="password" name="password" placeholder="New Password">
                </div>

                <div class="mb-4">
                    <input class="border-b border-indigo-300 w-full py-2 px-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:border-indigo-500" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm New Password">
                </div>
