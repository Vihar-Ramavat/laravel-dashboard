    ...
    <div class="flex justify-center items-center h-screen bg-gradient-to-r from-purple-800 to-indigo-900">
        <div class="w-full max-w-md bg-white shadow-md rounded-lg px-8 py-10">
            ...
            <form id="registerForm" class="mb-4">
                ...
                <div class="mb-4 relative">
                    <input class="border-b border-indigo-300 w-full py-2 px-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:border-indigo-500" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm Password" required>
